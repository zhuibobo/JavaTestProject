...
public class Demo010PersonPropertyEditorControllerTest {
    ...
    public void getPerson() throws Exception {
        MockHttpServletRequestBuilder requestBuilder =post("/demo010PersonPropertyEditor/getPerson.do?person=孙悟空");
