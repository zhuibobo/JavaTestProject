...
public class P002Test extends MainApplicationTest {
    ...
    * */
    ...
    public void createDeployment() throws InterruptedException, IOException {
        ...
        InputStream processModel = repositoryService.getProcessModel("Process_0rdfusd:15:d826c650-0ccd-11ea-8136-005056c00001");
        FileUtils.copyInputStreamToFile(processModel,new File("D:\\JavaProject\\JavaTestProject\\CamundaProject13\\src\\main\\resources\\bpmn\\P002_001_Copy.bpmn"));
        InputStream processDiagram = repositoryService.getProcessDiagram("Process_0rdfusd:15:d826c650-0ccd-11ea-8136-005056c00001");
